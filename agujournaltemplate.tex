...
\begin{table}
	...
	\begin{tabular}{lll|cccc|cccc}
		...
		&  & \multicolumn{1}{r|}{Levels:} & PL & PT & PV & SC & PL & PT & PV & SC \\
		\hline 
		\multicolumn{11}{l}{\textbf{Circulation variables}} \\
		...
		\ Montgomery potential & MONT & m$^{2}$ s$^{-2}$ &  & $\bullet$ &  &  &  &  &  & \\ \ Montgomery stream function & MNTSF & m$^{2}$ s$^{-1}$ &  &  &  &  &  & $\bullet$ &  &  \\
		\multicolumn{11}{l}{\textbf{Moisture variables}} \\
		\ Relative humidity & Q & \% & $\bullet$ &  &  &  & $\bullet$ & $\bullet$ &  & $\bullet$ \\
		...
		\multicolumn{11}{l}{\textbf{Temperature variables}} \\
		...
		\multicolumn{11}{l}{\textbf{Others}} \\
		\ Snow depth & SD & m of w.e. &  &  &  & $\bullet$ &  &  &  &  \\
		\hline
		\multicolumn{11}{l}{PL = pressure levels, PT = pot. temp. levels, PV = pot. vorticity levels, SC = surface or total column}\\
