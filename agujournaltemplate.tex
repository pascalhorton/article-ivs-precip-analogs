...
\title{Automatic input variable selection with genetic algorithms for analog methods}
...
\begin{enumerate}
	...
	\item Non-uniform mutation (pmut=0.1, Gmr=50, w=0.1)
	\item Non-uniform mutation (pmut=0.1, Gmr=100, w=0.1)
	\item Non-uniform mutation (pmut=0.2, Gmr=100, w=0.1)
\end{enumerate}
