...
\begin{table}
	...
	\begin{tabular}{lll|cccc|cccc}
		...
		\ Zonal wind & U & m s$^{-1}$ & $\bullet$ & $\bullet$ & $\bullet$ &   $^{\ }\bullet^{a}$ & $\bullet$ & $\bullet$ & $\bullet$ &  \\
		\ Meridional wind & V & m s$^{-1}$ & $\bullet$ & $\bullet$ & $\bullet$ &   $^{\ }\bullet^{a}$ & $\bullet$ & $\bullet$ & $\bullet$ &  \\
		...
		\multicolumn{11}{l}{*moisture and temperature variable, $^{a}$at 2~m, $^{b}$at 10~m, $^{c}$at mean sea level.}\\
		\hline 
	\end{tabular}}
...
\begin{figure}[h]
	\noindent\makebox[\textwidth]{
		\includegraphics[width=160mm]{figures/criteria.pdf}
	}
...
\begin{figure}[h]
	\noindent\makebox[\textwidth]{
		\includegraphics[width=160mm]{figures/variables-importance.pdf}
	}
